...
class PaginatorHelper extends \Cake\View\Helper\PaginatorHelper
{
    ...
    protected $_defaultConfig = [
        ...
        'templates' => [
            ...
            'prevActive' => '<li class="page-prev"><a class="btn btn-action " rel="prev" href="{{url}}">{{text}}</a></li>',
            'prevDisabled' => '<li class="page-prev  disabled"><a class="btn btn-action disabled" href="">{{text}}</a></li>',
