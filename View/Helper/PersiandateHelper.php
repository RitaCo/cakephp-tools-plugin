...
class PersiandateHelper extends AppHelper

{
...

	{
		...
		return $this->pdate($format,$time_stamp);
...

		{
...

			{
				...
				case "A":
					...
					if($result1=="pm") $result.= "بعد از ضهر";

					else $result.="قبل از ضهر";
				...
				case "l":
					...
					else if($result1=="Sunday") $result1="یکشبه";
